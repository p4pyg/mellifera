...
class TradetransactionController extends \BaseController {
	...
	public function index()
	{
		...
		$response 	= $client->get( [ 'url' => "http://api.mellifera.cu.cc/atomic/atomic/tradetransactions" ] );
	...
	{
		$client 	= new HttpClient;
		$response 	= $client->get( [ 'url' => "http://api.mellifera.cu.cc/atomic/atomic/tradetransactions/" . $id ] );
		$view 		= BeeTools::is_error( $response );
		if( $view ){
			return $view;
		}
